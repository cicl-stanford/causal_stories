...
# Default values for parameters (match step 1 / conditions)
DEFAULT_BLOCK_FRICTION = BLOCK_FRICTION_GREY
DEFAULT_RAMP_FRICTION = RAMP_FRICTION_GREY
DEFAULT_BLOCK_NOISE_SD = 0.05
DEFAULT_RAMP_NOISE_SD = 0.05
DEFAULT_FORCE_MAGNITUDE = FORCE_MAGNITUDE
